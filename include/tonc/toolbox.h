...
*/
INLINE int bit_tribool(u32 flags, int plus, int minus) { return ((flags >> plus) & 1) - ((flags >> minus) & 1); }
...
//! Hide an object.
INLINE void obj_hide(OBJ_ATTR *obj) { BFN_SET2(obj->attr0, ATTR0_HIDE, ATTR0_MODE); }
...
*/
INLINE void obj_unhide(OBJ_ATTR *obj, u16 mode) { BFN_SET2(obj->attr0, mode, ATTR0_MODE); }
